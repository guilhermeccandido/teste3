            ...
            <thead>
              <tr>
	            ...
	            <tbody>
	              ...
	              foreach($pas_localizacao as $row)
	              {
	                echo '<tr>';
	                echo '<td>'.$row['id'].'</td>';
					echo '<td>'.$row['tipo'].'</td>';
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/pas_localizacao/update/'.$row['id'].'/'.$id_pas.'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	function open_modal(id, id2){
		$("#actionModal").attr("href","<?php echo site_url("admin"); ?>" + "/pas_localizacao/delete/"+id+"/"+id2);
	}
