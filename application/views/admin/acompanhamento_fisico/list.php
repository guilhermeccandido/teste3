	  ...
	  <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            $options_acompanhamento_fisico = array();    
            foreach ($acompanhamento_fisico as $array) {
              foreach ($array as $key => $value) {
                $options_acompanhamento_fisico[$key] = $key;
              }
              break;
            }

            echo form_open("admin/acompanhamento_fisico", $attributes);
              ...
              echo form_dropdown("order", $options_acompanhamento_fisico, $order, 'class="form-control"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
				...
				<th class="yellow header headerSortDown">Slug</th>
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/acompanhamento_fisico/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "acompanhamento_fisico/delete/"+id);
		}
