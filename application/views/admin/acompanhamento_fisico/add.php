    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/acompanhamento_fisico/add", $attributes); ?>
		     <fieldset>
		     <legend>Adicionar</legend>
		     	<div class="form-group"">
		            <div class="col-lg-6">
		               <input class="form-control" type="text" id="tipo" name="tipo" placeholder="Acompanhamento Físico" value="<?php echo set_value('tipo'); ?>" >
