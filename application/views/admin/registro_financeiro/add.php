    <div class="container top">
	      <ol class="breadcrumb">
	        ...
	        <li><a href="<?php echo site_url("admin/registro_financeiro"); ?>">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/registro_financeiro/add", $attributes); ?>		     
		     <fieldset>
		     <legend>Adicionar</legend>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="titulo" name="titulo"  placeholder="Financeiro" value="<?php echo set_value('titulo'); ?>" >
		            <span class="input-group-addon">Financeiro</span>
		        </div>
		      </div>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<?php echo form_dropdown('id_contrato', $options_contratos, set_value('id_contrato'), 'class="form-control"'); ?>
		            <span class="input-group-addon">Contrato</span>
		        </div>
		      </div>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="contrato" name="contrato"  placeholder="Label Contrato" value="<?php echo set_value('contrato'); ?>" >
		            <span class="input-group-addon">Label Contrato</span>
		        </div>
		      </div>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
