   ...
   <p class="visible-xs">
	  ...
	  <div class="row">	  	  
        <div class="main">
	      ...
	      <div class="row">
	      	<div class="col-md-6" >
	      		<div class="panel panel-default" data-sortable-id="morris-chart-1" data-init="true">
        ...
        <!-- begin col-6 -->
        	<div class="col-md-6">
            	<div class="panel panel-default" data-sortable-id="chart-chart-3">
                	<div class="panel-heading">
                    	<div class="panel-heading-btn">
                        	<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
	        ...
	        <div class="col-md-6">
		  	...
		  	<div class="col-md-6" >
	      		<div class="panel panel-default" data-sortable-id="morris-chart-1" data-init="true">
					...
					<h3 class="panel-title">Cronograma 2016 02</h3>
			    	</div>
			    	<div class="panel-body">
	      ...
	      <div class="row">
	      	<div class="col-md-6" >	      		
		      	<div class="panel panel-default" data-sortable-id="morris-chart-2" data-init="true" >
					<div class="panel-heading">
					<div class="panel-heading-btn">
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
		    ...
		    <div class="col-md-6" >		    	
		      	<div class="panel panel-default" data-sortable-id="morris-chart-3" data-init="true">
					<div class="panel-heading">
					<div class="panel-heading-btn">
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
		...
		<div id="content" class="content">
		    ...
		    <div class="row">
		        <!-- begin col-6 -->
		        <div class="col-md-6">
                    <div class="panel panel-default" data-sortable-id="morris-chart-1">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-repeat"></i></a>
                    ...
                    <div class="panel panel-default" data-sortable-id="morris-chart-2">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-repeat"></i></a>
		        ...
		        <!-- begin col-6 -->
		        <div class="col-md-6">
                    <div class="panel panel-default" data-sortable-id="morris-chart-3">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-repeat"></i></a>
                    ...
                    <div class="panel panel-default" data-sortable-id="morris-chart-4">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-repeat"></i></a>
