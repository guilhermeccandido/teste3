			...
			<div class="row">
				<div class="col-md-4 ">
					<ul class="breadcrumb">
						...
						<li class="active">Dashboard - Levantamento de Campo</li>
					</ul>
				</div>
				<div class="col-md-8 ">
									...
									<div class="row">
										<div class="col-md-2 col-sm-4 col-xs-6">
											...
											<div class="percent text-center">
												<h5>LOTE 1 TOTAL<span class="" style="color:blue;"><br/>
												<i class="fa fa-plus-circle"></i> 35.450</span></h5>
												<h5>TOTAL MENSAL <span class=""><br/>
												<i class="fa fa-plus-circle"></i> 15.450</span></h5>
												<span id="mini-bar-chart1" class="mini-bar-chart"></span>
											</div>
										</div>
										<div class="col-md-2 col-sm-4 col-xs-6">
											...
											<div class="percent text-center">
												<h5>LOTE 2 TOTAL<span class="" style="color:green;"><br/>
												<i class="fa fa-plus-circle"></i> 35.450</span></h5>
												<h5>TOTAL MENSAL <span class=""><br/>
												<i class="fa fa-plus-circle"></i> 8.050</span></h5>
												<span id="mini-bar-chart1" class="mini-bar-chart"></span>
											</div>
										</div>
										<div class="col-md-2 col-sm-4 col-xs-6">
											...
											<div class="percent text-center">
												<h5>LOTE 3 TOTAL<span class="" style="color:red;"><br/>
												<i class="fa fa-plus-circle"></i> 35.450</span></h5>
												<h5>TOTAL MENSAL <span class=""><br/>
												<i class="fa fa-plus-circle"></i> 5.387</span></h5>
												<span id="mini-bar-chart1" class="mini-bar-chart"></span>
											</div>
										</div>
										<div class="col-md-2 col-sm-4 col-xs-6">
											<div class="easy-pie-chart gold" data-percent="40">
												<span class="percent">40</span>
											</div>
											<div class="percent text-center">
												<h5>LOTE 4 TOTAL<span class="" style="color:orange;"><br/>
												<i class="fa fa-plus-circle"></i> 35.450</span></h5>
												<h5>TOTAL MENSAL <span class=""><br/>
												<i class="fa fa-plus-circle"></i> 4.450</span></h5>
												<span id="mini-bar-chart1" class="mini-bar-chart"></span>
											</div>
										</div>
										<div class="col-md-2 col-sm-4 col-xs-6">
											<div class="easy-pie-chart crey" data-percent="37">
												<span class="percent">37</span>
											</div>
											<div class="percent text-center">
												<h5>LOTE 5 TOTAL<span class="" style="color:purple;"><br/>
												<i class="fa fa-plus-circle"></i> 35.450</span></h5>
												<h5>TOTAL MENSAL <span class=""><br/>
												<i class="fa fa-plus-circle"></i> 7.450</span></h5>
												<span id="mini-bar-chart1" class="mini-bar-chart"></span>
											</div>
										</div>
										<div class="col-md-2 col-sm-4 col-xs-6">
											<div class="easy-pie-chart platinum" data-percent="56">
												<span class="percent">56</span>
											</div>
											<div class="percent text-center">
												<h5>LOTE 5 TOTAL<span class="" style="color:crey;"><br/>
												<i class="fa fa-plus-circle"></i> 35.450</span></h5>
												<h5>TOTAL MENSAL <span class=""><br/>
												<i class="fa fa-plus-circle"></i> 2.450</span></h5>
												<span id="mini-bar-chart1" class="mini-bar-chart"></span>
											</div>
										</div>
									</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="widget widget-chart-toggle-series">
								<div class="widget-header">
									<h3><i class="fa fa-bar-chart-o"></i>Levantamento de Campo</h3>
									<div class="btn-group widget-header-toolbar">
										<a href="#" title="Focus" class="btn-borderless btn-focus"><i class="fa fa-eye"></i></a>
										<a href="#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
										<a href="#" title="Remove" class="btn-borderless btn-remove"><i class="fa fa-times"></i></a>
						...
						<div class="col-md-12">
							...
							<div class="widget widget-chart-toggle-series">
								<div class="widget-header">
									<h3><i class="fa fa-bar-chart-o"></i>Estado da Rodovia</h3>
									<div class="btn-group widget-header-toolbar">
										<a href="#" title="Focus" class="btn-borderless btn-focus"><i class="fa fa-eye"></i></a>
										<a href="#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
										<a href="#" title="Remove" class="btn-borderless btn-remove"><i class="fa fa-times"></i></a>
						...
						<div class="col-md-12">
							...
							<div class="widget widget-chart-toggle-series">
								<div class="widget-header">
									<h3><i class="fa fa-bar-chart-o"></i>Levantamento de Campo Acumulado</h3>
									<div class="btn-group widget-header-toolbar">
										<a href="#" title="Focus" class="btn-borderless btn-focus"><i class="fa fa-eye"></i></a>
										<a href="#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
										<a href="#" title="Remove" class="btn-borderless btn-remove"><i class="fa fa-times"></i></a>
...
$(document).ready(function(){
	...
	*/
	...
	function chartToggleSeriesAccu(placeholder) {
		...
		$.each(datasets['lote1']['data'], function(key, val) {
			accu = datasets['lote1']['data'][key][1] + accu;
			datasets['lote1']['data'][key][1] = accu;
		});
		...
		$.each(datasets['lote2']['data'], function(key, val) {
			accu = datasets['lote2']['data'][key][1] + accu;
			datasets['lote2']['data'][key][1] = accu;
		});
		...
		$.each(datasets['lote3']['data'], function(key, val) {
			accu = datasets['lote3']['data'][key][1] + accu;
			datasets['lote3']['data'][key][1] = accu;
		});
		...
		$.each(datasets['lote4']['data'], function(key, val) {
			accu = datasets['lote4']['data'][key][1] + accu;
			datasets['lote4']['data'][key][1] = accu;
		});
		...
		$.each(datasets['lote5']['data'], function(key, val) {
			accu = datasets['lote5']['data'][key][1] + accu;
			datasets['lote5']['data'][key][1] = accu;
		});
		...
		$.each(datasets['lote6']['data'], function(key, val) {
			accu = datasets['lote6']['data'][key][1] + accu;
			datasets['lote6']['data'][key][1] = accu;
		});
	...
	function plotWithOptions() {
		...
		var data = [
		            {label: 'Pavimentada', data: d1},
		            {label: 'Planejada', data: d2},
		            {label: 'Não Pavimentada', data: d3},
		        ];
	...
	if( $('.easy-pie-chart').length > 0 ) {
		...
		//BLUE LOTE 4
		cOptions.barColor = '#FF6600';
		cOptions.trackColor = '#FF9933';
		$('.easy-pie-chart.gold').easyPieChart(cOptions);
		//BLUE LOTE 5
		cOptions.barColor = '#990000';
		cOptions.trackColor = '#990066';
		$('.easy-pie-chart.crey').easyPieChart(cOptions);
		//BLUE LOTE 6
		cOptions.barColor = '#999999';
		cOptions.trackColor = '#CCCCCC';
		$('.easy-pie-chart.platinum').easyPieChart(cOptions);
