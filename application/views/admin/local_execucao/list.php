   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            foreach ($local_execucao as $array) {
              foreach ($array as $key => $value) {
                $options_local_execucao[$key] = $key;
              }
              break;
            }

            echo form_open("admin/local_execucao", $attributes);
              ...
              echo form_dropdown("order", $options_local_execucao, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/local_execucao/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/local_execucao/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "local_execucao/delete/"+id);
		}		
		*/
	</script>