<div class="container-fluid">		  
	  <div class="row">	  	  
        <div class="main">
          ...
          <div class="well">
            ...
            $options_coordenacao_geral = array();    
            foreach ($coordenacao_geral as $array) {
              foreach ($array as $key => $value) {
                $options_coordenacao_geral[$key] = $key;
              }
              break;
            }

            echo form_open("admin/coordenacao_geral", $attributes);
              ...
              echo form_dropdown("order", $options_coordenacao_geral, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/coordenacao_geral/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
              		  <a href="'.site_url("admin").'/coordenacao_geral_setorial/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Setores</a>
              		  <a href="'.site_url("admin").'/coordenacao_geral_contratos/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Contratos</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/coordenacao_geral/delete/"+id);
		}
