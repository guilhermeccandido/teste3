   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            $options_documentos_atividades = array();    
            foreach ($documentos_atividades as $array) {
              foreach ($array as $key => $value) {
                $options_documentos_atividades[$key] = $key;
              }
              break;
            }

            echo form_open("admin/documentos_atividades", $attributes);
              ...
              echo form_dropdown("order", $options_documentos_atividades, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
	              <?php
	              foreach($documentos_atividades as $row)
	              {
	                echo '<tr>';
	                echo '<td>'.$row['id'].'</td>';
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/documentos_atividades/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/documentos_atividades/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "documentos_atividades/delete/"+id);
		}		
		*/
	</script>