    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/coordenacao_setorial/add", $attributes); ?>		     
		     <fieldset>
		     <legend>Adicionar</legend>
		     	  <div class="form-group col-lg-12">
		        	<div class="input-group col-lg-8">
		              <input class="form-control" type="text" id="titulo" name="titulo"  placeholder="Coordenação Setorial" value="<?php echo set_value('titulo'); ?>" >
		              <span class="input-group-addon">Coordenação Setorial</span>
		            </div>
		          </div>
		          <div class="form-group col-lg-12">
		        	<div class="input-group col-lg-8">
		              <input class="form-control" type="text" id="alias" name="alias"  placeholder="Coordenação Setorial Alias" value="<?php echo set_value('alias'); ?>" >
