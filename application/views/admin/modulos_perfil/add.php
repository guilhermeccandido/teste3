    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/modulos_perfil/add/".$id_modulos."/".$id_usuario_perfil, $attributes); ?>
		     <fieldset>
		     <legend>Adicionar</legend>
			  <input class="form-control" type="hidden" id="id_modulos" name="id_modulos"  value="<?php echo $id_modulos; ?>" >
			  <input class="form-control" type="hidden" id="id_usuario_perfil" name="id_usuario_perfil"  value="<?php echo $id_usuario_perfil; ?>" >
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<?php echo form_dropdown("id_submodulo", $options_submodulos, set_value("id_submodulo"), 'class="form-control"' );?>
		            <span class="input-group-addon">Submódulo</span>
		        </div>
		      </div>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
