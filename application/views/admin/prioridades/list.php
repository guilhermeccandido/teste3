   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            foreach ($prioridades as $array) {
              foreach ($array as $key => $value) {
                $options_prioridades[$key] = $key;
              }
              break;
            }

            echo form_open("admin/prioridades", $attributes);
              ...
              echo form_dropdown("order", $options_prioridades, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/prioridades/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/prioridades/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "prioridades/delete/"+id);
		}		
		*/
	</script>