<div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            $options_gestao_estudos_projetos = array();    
            foreach ($gestao_estudos_projetos as $array) {
              foreach ($array as $key => $value) {
                $options_gestao_estudos_projetos[$key] = $key;
              }
              break;
            }

            echo form_open("admin/gestao_estudos_projetos", $attributes);
              ...
              echo form_dropdown("order", $options_gestao_estudos_projetos, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            <thead>
	              <tr>
	            	<th class="header">#</th>
				<th class="yellow header headerSortDown">Estudo / Projeto</th>
	            ...
	            <tbody>
	              <?php
	              foreach($gestao_estudos_projetos as $row)
	              {
	                echo '<tr>';
	                echo '<td>'.$row['id'].'</td>';
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/gestao_estudos_projetos/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/gestao_estudos_projetos/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "gestao_estudos_projetos/delete/"+id);
		}		
		*/
	</script>