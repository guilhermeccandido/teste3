<div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="table-responsive">
	        ...
	        <tbody>
              <?php
              foreach($anteprojetos_pendencias as $row)
              {
                echo "<tr>";
                echo "<td>".$row["id"]."</td>";
				...
				echo '<td>'.$row['observacoes'].'</td>';
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/anteprojetos_pendencias/update/'.$row['id'].'/'.$id_anteprojetos.'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	                  <a href="#myModal" class="btn btn-danger" data-toggle="modal" onclick="open_modal('.$row['id'].', '.$id_anteprojetos.');" style="width: 130px;">deletar</a>
	                </td>';
	                echo "</tr>";
	              }
	...
	<script>
		...
		function open_modal(id, id2){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/anteprojetos_pendencias/delete/"+id+"/"+id2);
		}
    
		/*
		function open_modal(id){
			$("#actionModal").attr("href", "anteprojetos_pendencias/delete/"+id);
		}
		*/
	</script>