<div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            echo form_open("admin/orcamento", $attributes);
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            <thead>
	              <tr>
	            	<th class="header">#</th>
					<th class="yellow header headerSortDown">Orçamento</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/orcamento/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	      			  <a href="'.site_url("admin").'/orcamento/projecoes/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Projeções</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/orcamento/delete/"+id);
		}
