<div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            foreach ($pendencias as $array) {
              foreach ($array as $key => $value) {
                $options_pendencias[$key] = $key;
              }
              break;
            }

            echo form_open("admin/pendencias", $attributes);
              ...
              echo form_dropdown("order", $options_pendencias, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
				...
				<th class="yellow header headerSortDown">Cor</th>
	            ...
	            <tbody>
	              ...
	              foreach($pendencias as $row)
	              {
					...
					echo '<td bgcolor="'.$row['cor'].'" >'.$row['cor'].'</td>';
					
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/pendencias/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/pendencias/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "pendencias/delete/"+id);
		}		
		*/
	</script>