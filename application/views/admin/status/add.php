    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/status/add", $attributes); ?>		     
		     <fieldset>
		     <legend>Adicionar</legend>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="titulo" name="titulo"  placeholder="Status" value="<?php echo set_value('titulo'); ?>" >
		            <span class="input-group-addon">Status</span>
		        </div>
		      </div>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="peso" name="peso"  placeholder="Peso" value="<?php echo set_value('peso'); ?>" >
		      ...
		      <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<?php
		        		echo form_dropdown('composicao', $options_composicao, set_value('composicao'), 'class="form-control"');
		        	?>
		      ...
		      <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<?php
		        		echo form_dropdown('tipo', $options_tipos, set_value('tipo'), 'class="form-control"');
		        	?>
		      ...
		      <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<?php
		        		echo form_dropdown('id_usuario_perfil', $options_perfil, set_value('id_usuario_perfil'), 'class="form-control"');
		        	?>
			  ...
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<?php
		        		echo form_dropdown('id_modulo', $options_modulos, set_value('id_modulo'), 'class="form-control"');
		        	?>
		      ...
		      <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="color" id="color" name="color"  placeholder="Cor" value="<?php echo set_value('color'); ?>" >
		        </div>
		      </div>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
