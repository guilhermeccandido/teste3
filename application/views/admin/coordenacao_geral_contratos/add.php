    <div class="container top">
	      <ol class="breadcrumb">
	        ...
	        <li>
	         <a href="<?php echo site_url("admin").'/'.$this->uri->segment(2)."/".$id_coordenacao_geral; ?>">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/coordenacao_geral_contratos/add/".$id_coordenacao_geral, $attributes); ?>
		     <fieldset>
		     <legend>Adicionar</legend>
			  <input class="form-control" type="hidden" id="id_coordenacao_geral" name="id_coordenacao_geral"  value="<?php echo $id_coordenacao_geral; ?>" >
