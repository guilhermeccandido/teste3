	       ...
	       <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
	          <div class="panel panel-warning">
				<div class="panel-heading">
	              ...
	              <h3 class="panel-title">Trechos PAS</h3>
	            </div>
	          ...
	          <div class="panel panel-warning">
	            ...
	            <div class="panel-body">
					   <div class="table-responsive">
			            ...
			            if(sizeof($pas_fases) > 0 && sizeof($pas) > 0 ){
			              ...
			              foreach($pas_fases as $row)
			              {
			                echo "<tr class='".$row['classe']."'>";
					          ...
					          echo '<a href="'.site_url("admin").'/pas_fases_movimentacao/contratada/'.$row['id_pas'].'/'.$row['lastmov']['id_pas_fases'].'" class="btn btn-info" style="width: 130px;">Movimentar</a>';
...
google.load('visualization', '1.0', { packages:['timeline'], language:'br'});
	...
	function drawChart_stock_div2() { 
		...
		$.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/pas/get_cronograma_all_lotes_by_contratos",
            data:{position:'teste'},
            dataType: "json",
	...
	$("#menu-toggle").click(function(e) {
 	...
 	/* AGENDA */
 		...
 		var options = {
			events_source: "<?php echo base_url(); ?>admin/pas/get_pas_planejamento_all_lotes_by_contratos",
			view: 'year',
