   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            foreach ($avaliacoes as $array) {
              foreach ($array as $key => $value) {
                $options_avaliacoes[$key] = $key;
              }
              break;
            }

            echo form_open("admin/avaliacoes", $attributes);
              ...
              echo form_dropdown("order", $options_avaliacoes, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            <thead>
	              <tr>
	            	<th class="header">#</th>
						<th class="yellow header headerSortDown">Análise</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/avaliacoes/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/avaliacoes/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "avaliacoes/delete/"+id);
		}		
		*/
	</script>