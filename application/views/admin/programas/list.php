<div class="container-fluid">		  
          ...
          <div class="well">
            ...
            foreach ($programas as $array) {
              foreach ($array as $key => $value) {
                $options_programas[$key] = $key;
              }
              break;
            }

            echo form_open("admin/programas", $attributes);
              ...
              echo form_dropdown("order", $options_programas, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/programas/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/programas/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "programas/delete/"+id);
		}		
		*/
	</script>