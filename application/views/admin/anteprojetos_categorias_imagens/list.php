<div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
	      ...
	      <div class="page-header users-header">
    		<h2>
              Anteprojetos Categorias de Imagens
          ...
          <div class="well">
            ...
            $options_anteprojetos_categorias_imagens = array();    
            foreach ($anteprojetos_categorias_imagens as $array) {
              foreach ($array as $key => $value) {
                $options_anteprojetos_categorias_imagens[$key] = $key;
              }
              break;
            }

            echo form_open("admin/anteprojetos_categorias_imagens", $attributes);
              ...
              echo form_dropdown("order", $options_anteprojetos_categorias_imagens, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
	              <?php
	              foreach($anteprojetos_categorias_imagens as $row)
	              {
	                echo '<tr>';
	                echo '<td>'.$row['id'].'</td>';
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/anteprojetos_categorias_imagens/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/anteprojetos_categorias_imagens/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "anteprojetos_categorias_imagens/delete/"+id);
		}		
		*/
	</script>