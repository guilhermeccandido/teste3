    <div class="container top">
		              ...
		              foreach($acompanhamento_fisico as $row)
		              {
						...
						echo '</td>';
			          	echo '<td class="crud-actions" style="width:180px;">
		              		  <a href="'.site_url("admin").'/pas_list_acompanhamento_fisico/add/'.$id_pas.'/'.$row['id'].'" class="btn btn-info">Files</a>
			                  <a href="'.site_url("admin").'/pas_acompanhamento_fisico/update/'.$row['id'].'" class="btn btn-info">Editar</a>  
     ...
     <script>
		...
		function open_modal(id, id2){
			$("#actionModal").attr("href","<?php echo site_url("admin"); ?>" + "/pas_acompanhamento_fisico/delete/"+id+"/"+id2);
		}
