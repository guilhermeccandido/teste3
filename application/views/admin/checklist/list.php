   ...
   <div class="container-fluid">		  
          ...
          <div class="well">
            ...
            foreach ($checklist as $array) {
              foreach ($array as $key => $value) {
                $options_checklist[$key] = $key;
              }
              break;
            }

            echo form_open("admin/checklist", $attributes);
              ...
              echo form_dropdown("order", $options_checklist, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/checklist/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/checklist/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "checklist/delete/"+id);
		}		
		*/
	</script>