   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            $options_documentos_od = array();    
            foreach ($documentos_od as $array) {
              foreach ($array as $key => $value) {
                $options_documentos_od[$key] = $key;
              }
              break;
            }

            echo form_open("admin/documentos_od", $attributes);
              ...
              echo form_dropdown("order", $options_documentos_od, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            <thead>
	              <tr>
	            	<th class="header">#</th>
				<th class="yellow header headerSortDown">Origem/Destino</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/documentos_od/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/documentos_od/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "documentos_od/delete/"+id);
		}		
		*/
	</script>