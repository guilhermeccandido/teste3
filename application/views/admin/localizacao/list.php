	  ...
	  <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            $options_localizacao = array();    
            foreach ($localizacao as $array) {
              foreach ($array as $key => $value) {
                $options_localizacao[$key] = $key;
              }
              break;
            }

            echo form_open("admin/localizacao", $attributes);
              ...
              echo form_dropdown("order", $options_localizacao, $order, 'class="form-control"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
            	<th class="header">#</th>
				<th class="yellow header headerSortDown">Localização</th>
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/localizacao/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "localizacao/delete/"+id);
		}
