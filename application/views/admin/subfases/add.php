    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/subfases/add/".$id_fases, $attributes); ?>		     
		     <fieldset>
		     ...
		     <input class="form-control" type="hidden" id="id_fases" name="id_fases"  placeholder="Produto" value="<?php echo $id_fases; ?>" >
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="titulo" name="titulo"  placeholder="Sub Produto" value="<?php echo set_value('titulo'); ?>" >
