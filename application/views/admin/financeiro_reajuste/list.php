   ...
   <div class="container-fluid">		  
		...
		<ol class="breadcrumb">
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
	              <?php
	              foreach($financeiro_reajuste as $row)
	              {
	                echo '<tr>';
	                echo '<td>'.$row['id'].'</td>';
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/financeiro_reajuste/update/'.$row['id'].'/'.$id_registro_financeiro.'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id, id2){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/financeiro_reajuste/delete/"+id+"/"+id2);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "financeiro_reajuste/delete/"+id);
		}		
		*/
	</script>