    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/financeiro_reajuste/add/".$id_registro_financeiro, $attributes); ?>		     
		     <fieldset>
		     <legend>Adicionar</legend>
		     <input type="hidden" id="id_registro_financeiro" name="id_registro_financeiro" value="<?php echo $id_registro_financeiro ?>" /> 
			  ...
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="reajuste" name="reajuste"  placeholder="Reajuste" value="<?php echo set_value('reajuste'); ?>" >
