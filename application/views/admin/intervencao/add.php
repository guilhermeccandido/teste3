    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/intervencao/add", $attributes); ?>		     
		     <fieldset>
		     <legend>Adicionar</legend>
		      <div class="form-group col-lg-12">
	        	<div class="input-group col-lg-8">
	              <input class="form-control" type="text" id="titulo" name="titulo"  placeholder="Intervenção" value="<?php echo set_value('titulo'); ?>" >
