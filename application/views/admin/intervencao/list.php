<div class="container-fluid">		  
	  <div class="row">	  	  
        <div class="main">
          ...
          <div class="well">
            ...
            $options_intervencao = array();    
            foreach ($intervencao as $array) {
              foreach ($array as $key => $value) {
                $options_intervencao[$key] = $key;
              }
              break;
            }

            echo form_open("admin/intervencao", $attributes);
              ...
              echo form_dropdown("order", $options_intervencao, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/intervencao/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/intervencao/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "intervencao/delete/"+id);
		}		
		*/
	</script>