   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            foreach ($estados as $array) {
              foreach ($array as $key => $value) {
                $options_estados[$key] = $key;
              }
              break;
            }

            echo form_open("admin/estados", $attributes);
              ...
              echo form_dropdown("order", $options_estados, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
				...
				<th class="yellow header headerSortDown">Estado</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/estados/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/estados/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "estados/delete/"+id);
		}		
		*/
	</script>