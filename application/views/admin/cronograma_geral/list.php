   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            $options_cronograma_geral = array();    
            foreach ($cronograma_geral as $array) {
              foreach ($array as $key => $value) {
                $options_cronograma_geral[$key] = $key;
              }
              break;
            }

            echo form_open("admin/cronograma_geral", $attributes);
              ...
              echo form_dropdown("order", $options_cronograma_geral, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
				...
				<th class="yellow header headerSortDown">Data Início</th>
				<th class="yellow header headerSortDown">Data Fim</th>
				<th class="yellow header headerSortDown">Ativo</th>
	            ...
	            <tbody>
	              <?php
	              foreach($cronograma_geral as $row)
	              {
	                echo '<tr>';
	                echo '<td>'.$row['id'].'</td>';
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/cronograma_geral/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/cronograma_geral/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "cronograma_geral/delete/"+id);
		}		
		*/
	</script>