    <div class="container top">
	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success alert-dismissible" role="alert">';
	            ...
	            echo '<strong>Parabéns!</strong> novo  documentos criado com sucesso.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
		     ...
		     <?php echo form_open("admin/documentos/add", $attributes);?>
		     <fieldset>
		     	  <div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="last_update" value="<?php echo set_value('last_update'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div>
