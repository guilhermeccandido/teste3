    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/imagens/add", $attributes); ?>		     
		     <fieldset>
		     <legend>Adicionar</legend>
			  ...
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="data_registro" name="data_registro"  placeholder="Data Registro" value="<?php echo set_value('data_registro'); ?>" >
