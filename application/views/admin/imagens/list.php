<div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            $options_imagens = array();    
            foreach ($imagens as $array) {
              foreach ($array as $key => $value) {
                $options_imagens[$key] = $key;
              }
              break;
            }

            echo form_open("admin/imagens", $attributes);
              ...
              echo form_dropdown("order", $options_imagens, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
				...
				<th class="yellow header headerSortDown">Data Registro</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/imagens/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/imagens/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "imagens/delete/"+id);
		}		
		*/
	</script>