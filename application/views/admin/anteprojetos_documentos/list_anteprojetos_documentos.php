    <div class="container top">
	      ...
	      <div class="page-header users-header">
    		<h2>
              ...
              <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2).'/add/'.$id_anteprojeto; ?>" class="btn btn-success">Adicionar Novo</a>
            </h2>
          </div>
	  <div class="row">
	              ...
	              <tr>
		            ...
		            <tbody>
		              ...
		              foreach($documentos as $row)
		              {
						...
						echo '<td>
	          						<a href="'.base_url().'/assets/anteprojetos/'.$id_anteprojeto.'/documentos/'.$row['nome'].'" target="blank" >'.$row['nome'].'</a>
	          				  </td>';
						echo '<td>'.$row['tipo'].'</td>';
						...
						echo '<td>'.$row['last_update'].'</td>';
			          	...
			          	echo '<td class="crud-actions">
			                  <a href="'.site_url("admin").'/anteprojetos_documentos/update/'.$row['id'].'" class="btn btn-info">Editar</a>  
     ...
     <script>
		...
		function open_modal(id, id2){
			$("#actionModal").attr("href","<?php echo site_url("admin"); ?>" + "/anteprojetos_documentos/delete/"+id+"/"+id2);
		}
