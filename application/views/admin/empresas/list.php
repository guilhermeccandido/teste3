<div class="container-fluid">		  
          ...
          <div class="well">
            ...
            foreach ($empresas as $array) {
              foreach ($array as $key => $value) {
                $options_empresas[$key] = $key;
              }
              break;
            }

            echo form_open("admin/empresas", $attributes);
              ...
              echo form_dropdown("order", $options_empresas, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/empresas/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/empresas/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "empresas/delete/"+id);
		}		
		*/
	</script>