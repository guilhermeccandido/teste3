   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            foreach ($submodulos as $array) {
              foreach ($array as $key => $value) {
                $options_submodulos[$key] = $key;
              }
              break;
            }

            echo form_open("admin/submodulos", $attributes);
              ...
              echo form_dropdown("order", $options_submodulos, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            <thead>
	              <tr>
	            	<th class="header">#</th>
				<th class="yellow header headerSortDown">Sub Módulo</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/submodulos/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/submodulos/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "submodulos/delete/"+id);
		}		
		*/
	</script>