   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            foreach ($usuario_perfil as $array) {
              foreach ($array as $key => $value) {
                $options_usuario_perfil[$key] = $key;
              }
              break;
            }

            echo form_open("admin/usuario_perfil", $attributes);
              ...
              echo form_dropdown("order", $options_usuario_perfil, $order, 'class="form-control"');
	          ...
	          <table class="table table-striped table-bordered table-condensed">
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/usuario_perfil/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/usuario_perfil/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "usuario_perfil/delete/"+id);
		}		
		*/
	</script>