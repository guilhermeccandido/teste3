    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/documentos_tipos/add", $attributes); ?>		     
		     <fieldset>
		     <legend>Adicionar</legend>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<input class="form-control" type="text" id="titulo" name="titulo"  placeholder="Tipo" value="<?php echo set_value('titulo'); ?>" >
		            <span class="input-group-addon">Tipo</span>
		        </div>
		      </div>
			  <div class="form-group col-lg-12">
		        <div class="input-group col-lg-8">
		        	<?php echo form_dropdown('modulo', $options_modulos, set_value('modulo'), 'class="form-control"'); ?>
