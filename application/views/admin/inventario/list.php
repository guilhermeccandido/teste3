   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            $options_inventario = array();    
            foreach ($inventario as $array) {
              foreach ($array as $key => $value) {
                $options_inventario[$key] = $key;
              }
              break;
            }

            echo form_open("admin/inventario", $attributes);
              ...
              echo form_dropdown("order", $options_inventario, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            <thead>
	              <tr>
	            	<th class="header">#</th>
				<th class="yellow header headerSortDown">Inventário</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/inventario/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/inventario/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "inventario/delete/"+id);
		}		
		*/
	</script>