    <div class="container top">
		 ...
		 <div class="row">
          <div class="col-lg-10">
         	<?php echo form_open("admin/modulos_modulos/add/".$id_modulos, $attributes); ?>
		     <fieldset>
		     <legend>Adicionar</legend>
			  <input class="form-control" type="hidden" id="id_modulo1" name="id_modulo1"  value="<?php echo $id_modulos; ?>" >
