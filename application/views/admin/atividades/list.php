...
<div class="container-fluid">		  
		...
		<div class="main">
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
	            <thead>
	              <tr>
					<th class="header headerSortDown" style="width: 90px;" >Data</th>
	            ...
	            <tbody>
	              ...
	              {
	                echo '<tr>';
					echo '<td>'.$row['data_atividade'].'</td>';
					echo '<td>'.$row['titulo'].'</td>';
					echo '<td>'.$row['status'].'</td>';
					echo '<td>'.$row['descricao'].'</td>';
			        echo '<td class="crud-actions">
			                  <a href="'.site_url("admin").'/atividades/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/atividades/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "atividades/delete/"+id);
		}		
		*/
	</script>