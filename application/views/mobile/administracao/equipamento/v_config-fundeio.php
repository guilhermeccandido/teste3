...
<body>
<div data-role="page" id="pageFormConfigBoia" data-theme="a">
    <div data-role="content" data-theme="a"> 
        <h3>Configuração dos Fundeios</h3>
        <p>Escolhe uma boia abaixo e clique em Editar.</p>
        <form name="configBoia" id="configBoia" method="post" action="<?php echo base_url(); ?>mobile/formConfigurarBoia">    	
