   ...
   <div class="container-fluid">		  
	<div class="row">	  	  
		<div class="main">
          ...
          <div class="well">
            ...
            $options_mapeamento = array();    
            foreach ($mapeamento as $array) {
              foreach ($array as $key => $value) {
                $options_mapeamento[$key] = $key;
              }
              break;
            }

            echo form_open("admin/mapeamento", $attributes);
              ...
              echo form_dropdown("order", $options_mapeamento, $order, 'class="form-control"');
          ...
          <div class="table-responsive">
	          <table class="table table-striped table-bordered table-condensed">
				...
				<th class="yellow header headerSortDown">Color</th>
	            ...
	            <tbody>
		          ...
		          echo '<td class="crud-actions">
	                  <a href="'.site_url("admin").'/mapeamento/update/'.$row['id'].'" class="btn btn-info" style="width: 130px;">Ver & editar</a>
	...
	<script>
		...
		function open_modal(id){
			$("#actionModal").attr("href", "<?php echo site_url("admin")?>/mapeamento/delete/"+id);
		}

		/*
		function open_modal(id){
			$("#actionModal").attr("href", "mapeamento/delete/"+id);
		}		
		*/
	</script>