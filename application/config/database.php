...
$db['default']['password'] = 'DntSgplan@)18';
$db['default']['database'] = 'db_covide';
$db['default']['dbdriver'] = 'postgre';
$db['default']['dbprefix'] = '';
$db['default']['pconnect'] = TRUE;
...
$db['siac']['database'] = 'SIMDNIT';
$db['siac']['dbdriver'] = 'sqlsrv';
$db['siac']['dbprefix'] = '';
$db['siac']['pconnect'] = TRUE;
$db['siac']['db_debug'] = TRUE;
$db['siac']['cache_on'] = FALSE;
$db['siac']['cachedir'] = '';
$db['siac']['char_set'] = 'utf8';
$db['siac']['dbcollat'] = 'utf8_general_ci';
$db['siac']['swap_pre'] = '';
