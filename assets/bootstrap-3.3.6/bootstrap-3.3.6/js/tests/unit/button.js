$(function () {
  ...
  QUnit.test('should return set state to loading', function (assert) {
    assert.expect(4)
    var $btn = $('<button class="btn btn-default" data-loading-text="fat">mdo</button>')
  ...
  QUnit.test('should work with an empty string as reset state', function (assert) {
    assert.expect(7)
    var $btn = $('<button class="btn btn-default" data-loading-text="fat"/>')
  ...
  QUnit.test('should toggle active', function (assert) {
    assert.expect(2)
    var $btn = $('<button class="btn btn-default" data-toggle="button">mdo</button>')
  ...
  QUnit.test('should toggle aria-pressed', function (assert) {
    assert.expect(2)
    var $btn = $('<button class="btn btn-default" data-toggle="button" aria-pressed="false">redux</button>')
